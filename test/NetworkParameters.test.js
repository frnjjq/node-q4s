const NetworkParameters = require('../src/NetworkParameters.js');

describe('NetworkParameters', function () {

  describe('updateWithSDP', function () {

    test(' SDP forms the object', function () {
...
"a=flow:q4s serverListeningPort TCP/56001\r\n";
      ...
      let netP = new NetworkParameters();
      netP.updateWithSDP(sdpCorrect);
  ...
  describe('addresesToSDP', function () {
    ...
    test('work properly', function () {
      let netP = new NetworkParameters("IP4", "198.51.100.51", "IP4", "198.51.100.58",{TCP:1,UDP:2},{TCP:1,UDP:2},{TCP:3,UDP:4},{TCP:5,UDP:6});
