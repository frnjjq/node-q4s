/**
 * Response Q4S module. Implements the Response Q4S class that allow response manipulation.
 * @module ResQ4S
 */

/** Response Q4S class. Options to build , generate, parse and validate Q4S responses*/
class ResQ4S {
  /**
   ...
   * @return {Object} On sucess an object of the class ResQ4S, on error returns an error.
   */
